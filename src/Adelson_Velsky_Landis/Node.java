...
public class Node {
    ...
    public void insert(int d){
        ...
        updateDepthBalance();
        //if disbalance, apply appropriate rotation
    }

    public void drawNode(Graphics g, int x, int y){
        if(left!=null){
            g.drawLine(x+10,y+10,x-40,y+60);
        ...
        g.drawString(s, x+10-g.getFontMetrics().stringWidth(s)/2,y);
